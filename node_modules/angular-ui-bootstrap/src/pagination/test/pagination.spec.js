describe('pagination directive', function() {
  ...
  describe('pagination directive with `boundary-linksPage`', function() {
    beforeEach(function() {
      element = $compile('<ul uib-pagination boundary-linksPage="true" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    });
    ...
    it('changes "first" & "last" text from attributes', function() {
      element = $compile('<ul uib-pagination boundary-linksPage="true" first-text="<<<" last-text=">>>" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "previous" & "next" text from attributes', function() {
      element = $compile('<ul uib-pagination boundary-linksPage="true" previous-text="<<" next-text=">>" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "first" & "last" text from interpolated attributes', function() {
      ...
      element = $compile('<ul uib-pagination boundary-linksPage="true" first-text="{{myfirstText}}" last-text="{{mylastText}}" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "previous" & "next" text from interpolated attributes', function() {
      ...
      $rootScope.nextText = '>>';
      element = $compile('<ul uib-pagination boundary-linksPage="true" previous-text="{{previousText}}" next-text="{{nextText}}" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
  ...
  describe('pagination directive with just number linksPage', function() {
    beforeEach(function() {
      element = $compile('<ul uib-pagination direction-linksPage="false" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('with just boundary & number linksPage', function() {
    beforeEach(function() {
      $rootScope.directions = false;
      element = $compile('<ul uib-pagination boundary-linksPage="true" direction-linksPage="directions" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('override configuration from attributes', function() {
    beforeEach(function() {
      ...
      element = $compile('<ul uib-pagination boundary-linksPage="true" page-label="pageLabel($page)" first-text="<<" previous-text="<" next-text=">" last-text=">>" total-items="total" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    });
